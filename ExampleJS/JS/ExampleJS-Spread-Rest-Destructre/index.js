...
const usersLessThanTwo = users.filter((u) => u.skills.length < 2);
console.log(usersLessThanTwo);
...
for (const { ad, sermaye, nufus, diller } of selectedCountries) {
  console.log(`Ülke Adı: ${ad}`);
  console.log(`Sermaye: ${sermaye}`);
  console.log(`Nüfus: ${nufus}`);
  console.log(`Dil: ${diller.join(", ")}`);
  console.log("======================");
}
